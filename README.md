...
[![Build Status](https://travis-ci.org/joshuacherry/ansible-role-kibana.svg?branch=master)](https://travis-ci.org/joshuacherry/ansible-role-kibana)
![Ansible](https://img.shields.io/badge/ansible-2.8-blue.svg)
![Ansible](https://img.shields.io/badge/ansible-2.9-blue.svg)

Configures [kibana](https://www.elastic.co/kibana) on a server.
...
`ansible-galaxy install git+https://github.com/joshuacherry/ansible-role-kibana.git`
...
For the versions available, see the [tags on this repository](https://github.com/joshuacherry/ansible-role-kibana/tags).
...
```bash
rsync -ua /ansible-role-kibana/ ~/ansible-role-kibana/ --delete
...
```yaml
---
- name: Playbook for ansible-role-kibana
  hosts: all
